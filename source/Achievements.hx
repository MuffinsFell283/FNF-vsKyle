...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["That's enough for today...",		"Beat Week Kyle on Hard with no Misses.",			'kyle_nomiss',		false],
		["So much fun!",					"Beat Week Lucas on Hard with no Misses.",			'lucas_nomiss',		false],
		["This is some kind of mistake!",	"Beat Week Lei on Hard with no Misses.",			'lei_nomiss',		false],
		["Very well done!",					"Beat Childhood week on Hard with no Misses.",		'kyleago_nomiss',	false],
		["IF YOU MOVE, IT WON'T HIT YOU!!",	"Beat Week Blent on Hard with no Misses.",			'blent_nomiss',		false],
		["I don't need anything else",		"...",												'future_nomiss',	 true],
		["Wow! You are so awesome!",		"Beat Ecstasy-EX no Misses",						'ex_nomiss',		false],
